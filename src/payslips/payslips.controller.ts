...
export class PayslipsController {
	...
	@ApiOperation({
		...
		description:
			'Fetch a payslip file from GCS using fileName and userId. If file is in an inaccessible bucket, creates record with provided sample data while maintaining consistent creator links',
	})
	...
	@ApiOperation({
		...
		description:
			'Process a payslip file from GCS, save it to doc entity, and notify the employee via email about payslip availability',
	})
